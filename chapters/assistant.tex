...
\begin{figure}[ht]
\includegraphics[width=0.47\textwidth]{figures/ft_filter.pdf}
...
\begin{figure}[t!]
    ...
    \includegraphics[width=0.9\columnwidth]{figures/pie.pdf}
    \caption{
...
\begin{figure*}[t!]
\centering
\includegraphics[width=0.95\textwidth]{figures/perf_conv_curves_new.pdf}
