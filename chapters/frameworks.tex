...
\quad In our project we propose a C++ template library of computational frameworks. Computational frameworks are a blend of imperative and functional programming paradigms. 
...
\quad Improves structuredness, modularity, separation of concerns. 
...
\quad Our computational frameworks are designed as C++ class templates.
...
class Framework {
    public:
        ...
        RetType compute(FuncType application_func);
    private:
